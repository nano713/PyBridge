...
class MyWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        layout.addWidget(self.x0_position)
        ...
        layout.addWidget(self.z1_pos)
        layout.addWidget(self.z1_input) 
